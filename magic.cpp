...
void loadSpellsFromScript()
{
	...
	for (int curspell = 0; curspell < MAX_SPELLS; curspell++) {
		...
		do
		{
			...
			if (!strcmp("ENABLED", (char*)script1)) 		g_Spells[curspell].enabled = true;
			else if (!strcmp("DISABLED", (char*)script1))	g_Spells[curspell].enabled = false;
			else if (!strcmp("CIRCLE", (char*)script1)) 	g_Spells[curspell].circle = str2num(script2);
			else if (!strcmp("MANA", (char*)script1))		g_Spells[curspell].mana = str2num(script2);
			else if (!strcmp("HISKILL", (char*)script1))	g_Spells[curspell].hiskill = str2num(script2);
			else if (!strcmp("LOSKILL", (char*)script1))	g_Spells[curspell].loskill = str2num(script2);
			else if (!strcmp("SCLO", (char*)script1))		g_Spells[curspell].sclo = str2num(script2);
			else if (!strcmp("SCHI", (char*)script1))		g_Spells[curspell].schi = str2num(script2);
			else if (!strcmp("LODAMAGE", (char*)script1))	g_Spells[curspell].lodamage = str2num(script2);
			else if (!strcmp("HIDAMAGE", (char*)script1))	g_Spells[curspell].hidamage = str2num(script2);
			else if (!strcmp("DAMAGETYPE", (char*)script1)) g_Spells[curspell].damagetype = static_cast<DamageType>(str2num(script2));
			else if (!strcmp("ATTACKSPELL", (char*)script1))g_Spells[curspell].attackSpell = true;
			else if (!strcmp("ALWAYSFLAG", (char*)script1)) g_Spells[curspell].alwaysflag = str2num(script2);
			else if (!strcmp("AREASIZE", (char*)script1))	g_Spells[curspell].areasize = str2num(script2);
			else if (!strcmp("MANTRA", (char*)script1)) 	g_Spells[curspell].mantra += (char*)script2;
			else if (!strcmp("ACTION", (char*)script1)) 	g_Spells[curspell].action = hex2num(script2);
			else if (!strcmp("DELAY", (char*)script1))		g_Spells[curspell].delay = str2num(script2);
			else if (!strcmp("ASH", (char*)script1))		g_Spells[curspell].reagents.ash = str2num(script2);
			else if (!strcmp("DRAKE", (char*)script1))		g_Spells[curspell].reagents.drake = str2num(script2);
			else if (!strcmp("GARLIC", (char*)script1)) 	g_Spells[curspell].reagents.garlic = str2num(script2);
			else if (!strcmp("GINSING", (char*)script1))	g_Spells[curspell].reagents.ginseng = str2num(script2);
			else if (!strcmp("MOSS", (char*)script1))		g_Spells[curspell].reagents.moss = str2num(script2);
			else if (!strcmp("PEARL", (char*)script1))		g_Spells[curspell].reagents.pearl = str2num(script2);
			else if (!strcmp("SHADE", (char*)script1))		g_Spells[curspell].reagents.shade = str2num(script2);
			else if (!strcmp("SILK", (char*)script1))		g_Spells[curspell].reagents.silk = str2num(script2);
			else if (!strcmp("TARG", (char*)script1))		g_Spells[curspell].strToSay += (char*)script2;
			else if (!strcmp("REFLECTABLE", (char*)script1))	g_Spells[curspell].reflect = true;
			else if (!strcmp("UNREFLECTABLE", (char*)script1))	  g_Spells[curspell].reflect = false;
			else if (!strcmp("RUNIC", (char*)script1))		g_Spells[curspell].runic = str2num(script2)!=0;
		}
		while (script1[0]!='}');
	}
	safedelete(iter);
