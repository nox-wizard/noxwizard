...
enum ItemType {
	...
	ITYPE_ALCHEMY = 500, ITYPE_ANATOMY = 501, ITYPE_ANIMAL_LORE = 502, ITYPE_ITEMID = 503, ITYPE_ARMS_LORE = 504, ITYPE_PARRYING = 505
	, ITYPE_BEGGING = 506, ITYPE_BLACKSMITHING = 507, ITYPE_BOWCRAFTING = 508, ITYPE_FLETCHING = 508, ITYPE_PEACEMAKING = 509, ITYPE_CAMPING = 510
	, ITYPE_CARPENTRY = 511, ITYPE_CARTOGRAPHY = 512, ITYPE_COOKING = 513, ITYPE_DETECT_HIDDEN = 514, ITYPE_ENTICEMENT = 515, ITYPE_EVALUATE_INTELLECT = 516
	, ITYPE_HEALING = 517, ITYPE_FISHING = 518, ITYPE_FORENSIC_EVALUATION = 519, ITYPE_HERDING = 520, ITYPE_HIDING = 521, ITYPE_PROVOCATION = 522
	, ITYPE_INSCRIPTION = 523, ITYPE_LOCKPICKING = 524, ITYPE_MAGERY = 525, ITYPE_MAGIC_RESISTANCE = 526, ITYPE_TACTICS = 527, ITYPE_SNOOPING = 528
	, ITYPE_MUSICIANSHIP = 529, ITYPE_POISONING = 530, ITYPE_ARCHERY = 531, ITYPE_SPIRIT_SPEAKING = 532, ITYPE_STEALING = 533, ITYPE_TAILORING = 534
	, ITYPE_ANIMAL_TAMING = 535, ITYPE_TASTE_IDENTIFICATION = 536, ITYPE_TINKERING = 537, ITYPE_TRACKING = 538, ITYPE_VETERINARY = 539
	, ITYPE_SWORDSMANSHIP = 540, ITYPE_MACEFIGHTING = 541, ITYPE_FENCING = 542, ITYPE_WRESTLING = 543, ITYPE_LUMBERJACKING = 544, ITYPE_MINING = 545
	, ITYPE_MEDITATION = 546, ITYPE_STEALTH = 547, ITYPE_REMOVE_TRAPS = 548
};
...
//! Human bodies and racial genders
enum { GENDER_NEUTRAL = 0, GENDER_MALE=1, GENDER_FEMALE=2, GENDER_FEMALE_OR_MALE=3};
