...
#define AMXEXECS(CHRSERIAL,TYPE,NUMBER,RET,MOMENT) { if (g_Scripts[TYPE][NUMBER].Exec(MOMENT,CHRSERIAL)) return RET; }
#define AMXEXECSV(CHRSERIAL,TYPE,NUMBER,MOMENT) { if (g_Scripts[TYPE][NUMBER].Exec(MOMENT,CHRSERIAL)) return; }
#define AMXEXECSVNR(CHRSERIAL,TYPE,NUMBER,MOMENT) { g_Scripts[TYPE][NUMBER].Exec(MOMENT,CHRSERIAL); }
#define AMXEXECSVTARGET(CHRSERIAL,TYPE,NUMBER,MOMENT) { if (g_Scripts[TYPE][NUMBER].ExecTarget(MOMENT,CHRSERIAL)) return; }
