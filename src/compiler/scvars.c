...
SC_VDEFINE constval tagname_tab = { NULL, "", 0};  /* tagname table */
SC_VDEFINE constval libname_tab = { NULL, "", 0};  /* library table (#pragma library "..." syntax) */
...
SC_VDEFINE int sc_listing= FALSE;  /* create .ASM file? */
...
SC_VDEFINE int makereport= FALSE;  /* do not generate a cross-reference report */
...
SC_VDEFINE int indent_nowarn=TRUE;/* skip warning "217 loose indentation" */
