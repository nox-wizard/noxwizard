...
{
	private:
		static SERIAL current_serial; //!< current serial
		static MENU_MAP menuMap; //!< every opened menus
	public:
		static SERIAL	createMenu( UI32 id, UI32 x, UI32 y, bool canMove, bool canClose, bool canDispose );
		static SERIAL	createMenu( UI32 id, UI32 x, UI32 y, UI08 options );
		static LOGICAL	deleteMenu( SERIAL gump );
		static LOGICAL	handleMenu( NXWCLIENT ps );
		static P_MENU selectMenu( SERIAL menu );
		static LOGICAL	showMenu( SERIAL menu, P_CHAR pc );
