...
/*!
\brief Stuff for Account Management
*/
namespace accounts
{	
	...
	*/
	...
	public:
		...
		UI32 lastlogin;			//!< Last login time
	...
	extern ACCOUNT_LIST acctlist;	//!< All Account, with info
	extern ACCOUNT_LIST_BY_NAME accbyname;	//!< All Account by name
	extern UI32 lastusedacctnum, unsavedaccounts;
	extern UI32 lasttimecheck;
	extern UI32 saveratio;
