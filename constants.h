...
//! Character priv2
enum {	CHRPRIV2_ALLMOVE = 0x01, CHRPRIV2_FROZEN = 0x02, CHRPRIV2_VIEWHOUSEASICON = 0x4,
	CHRPRIV2_PERMAHIDDEN = 0x8, CHRPRIV2_DONTUSEUPMANA = 0x10, CHRPRIV2_DISPELLABLE = 0x20,
	CHRPRIV2_REFLECTION = 0x40, CHRPRIV2_DONTUSEREAGENTS = 0x80
};

//! Character priv1
enum {	CHRPRIV_GM = 0x01, CHRPRIV_BROADCAST = 0x02, CHRPRIV_INVUL = 0x04, CHRPRIV_CANVIEWSERIALS = 0x08,
	CHRPRIV_NOSKILLTITLE = 0x10, CHRPRIV_GMPAGEABLE = 0x20, CHRPRIV_CANSNOOPALL = 0x40,
	CHRPRIV_COUNSELOR = 0x80
};

//! Character flags
enum {	CHRFLAG_INNOCENT = 0x4, CHRFLAG_MURDERER = 0x1, CHRFLAG_CRIMINAL = 0x2 };
...
//! Human bodies
enum { BODY_MALE = 0x190, BODY_FEMALE = 0x191, BODY_DEADMALE = 0x192, BODY_DEADFEMALE = 0x193 };
