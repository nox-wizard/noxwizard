...
enum ItemType {
	...
	ITYPE_RUNE = 50, ITYPE_MOONGATE=51, ITYPE_ITEM_SPAWNER = 61, ITYPE_NPC_SPAWNER = 62, ITYPE_UNLOCKED_CONTAINER = 63,
	...
	ITYPE_ADVENCEMET_GATE_SEX = 82, ITYPE_TRASH = 87, ITYPE_HOUSEDEED=90, ITYPE_BOATDEED=91, ITYPE_MULTIDEED=92,
	ITYPE_BOATS = 117, ITYPE_FIREWORKS_WAND = 181,
...
//! Human bodies
enum { GENDER_NEUTRAL = 0, GENDER_MALE=1, GENDER_FEMALE=2 };
