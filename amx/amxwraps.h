...
const int NXW_CP_C_SHOPKEEPER = 11;
...
const int NXW_CP_C_ID = 111;
const int NXW_CP_C_LOCKSKILL = 112;
const int NXW_CP_C_MULTISERIAL2 = 113;
...
const int NXW_CP_C_SKIN = 126;
const int NXW_CP_C_SPEECH = 127;
const int NXW_CP_C_WAR = 128;
const int NXW_CP_C_XID = 129;
const int NXW_CP_C_XSKIN = 130;
...
const int NXW_CP_I_MENUPRIV = 244;
...
//const int NXW_CP_I_REGEN = 271; //unused
//const int NXW_CP_I_REGEN2 = 272; //unused
//const int NXW_CP_I_REGEN3 = 273; //unused
...
const int NXW_CP_I_TAILITEM = 298;
...
const int NXW_CP_I_TRACKINGDISPLAYTIMER = 306;
const int NXW_CP_I_TRACKINGTARGET = 307;
const int NXW_CP_I_TRACKINGTIMER = 308;
...
const int NXW_IP_C_CONTAINERSERIAL2 = 101;
...
const int NXW_IP_C_OWNERSERIAL2 = 116;
const int NXW_IP_C_PILEABLE = 117;
const int NXW_IP_C_PRIV = 118;
const int NXW_IP_C_SERIAL2 = 119;
