 ...
 *
 *  Version: $Id: amx.h,v 1.5 2003/07/17 22:21:57 sparhawksf Exp $
 *
...
//prevent assertion failure in sc2.c with gcc 3.2 and later
#ifndef NDEBUG
#define NDEBUG
#endif
...
#define LINUX
   ...
   */
  #if (defined __LCC__ || defined __GNUC__) && !defined __FreeBSD__
    #include <stdint.h>
  #else
