...
void Skills::CreateBandageTarget(NXWSOCKET s)//-Frazurbluu- rewrite of tailoring to current OSI
{
    ...
    if (pi->magic!=4) // Ripper
    {
        ...
        sysmessage(s,TRANSLATE("You cannot cut anything from that item."));
    }
}
